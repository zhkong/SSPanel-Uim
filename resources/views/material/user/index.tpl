                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade active in" id="sub_center">
                                            ...
                                            <div class="tab-pane fade" id="sub_center_windows">
                                                {* s="icon icon-lg text-white">filter_1</span> Shadowsocks Windows - [ SS ]：</p>
                                                    <p>
                                                        应用下载：
                                                ...
                                                <hr /> *}                                         
                                                <p><span class="icon icon-lg text-white">filter_1</span> ShadowsocksR Windows - [ SS/SSR ]：</p>
                                                    <p>
                                                        应用下载：
                                            ...
                                            <div class="tab-pane fade" id="sub_center_mac">
                                                ...
                                                <p>
                                                  ...
                                                  <a class="btn-dl" href="/clients/ssr-mac.dmg"><i
                                                      class="material-icons icon-sm">cloud_download</i> 本站下载【高速】</a>
                                                </p>
                                                <p>
                                                  使用教程：
                                                  <a class="btn-dl"
                                            ...
                                            <div class="tab-pane fade" id="sub_center_android">
                                                ...
                                                <hr/>      *}                                           
                                                <p><span class="icon icon-lg text-white">filter_1</span> ShadowsocksR Android - [ SSR ]：</p>
                                                    <p>
                                                        应用下载：
                                            ...
                                            <div class="tab-pane fade" id="sub_center_linux">
                                                ...
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_2</span> Qv2ray - [ SS/SSR ]：</p>
                                                    <p>
                                                        应用下载：
...
<script src="/cache/npm/shake.js@1.2.2/shake.min.js"></script>
<script>
